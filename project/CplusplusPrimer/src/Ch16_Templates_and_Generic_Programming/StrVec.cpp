...
std::ostream& operator<<(std::ostream& out, const StrVec& str_vec)
{
...
/*
hello world fuck AAA is dream

E:\BooksLearn\CPP\CplusplusPrimer\project\CplusplusPrimer\Debug\CplusplusPrimer.exe (进程 20760)已退出，代码为 0。
按任意键关闭此窗口. . .
*/
